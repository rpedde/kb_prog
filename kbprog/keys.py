...
key_to_all = {
    ...
    'KC_FN30': (0x00de, '', '', ''),
    'KC_FN31': (0x00df, '', '', ''),
    'MS_UP': (0x00f0, '', 'Mouse', 'Up'),
    'MS_DOWN': (0x00f1, '', 'Mouse', 'Down'),
    'MS_LEFT': (0x00f2, '', 'Mouse', 'Left'),
    'MS_RIGHT': (0x00f3, '', 'Mouse', 'Right'),
    'MS_BTN1': (0x00f4, '', 'Mouse', 'Btn 1'),
    'MS_BTN2': (0x00f5, '', 'Mouse', 'Btn 2'),
    'MS_BTN3': (0x00f6, '', 'Mouse', 'Btn 3'),
    'MS_BTN4': (0x00f7, '', 'Mouse', 'Btn 4'),
    'MS_BTN5': (0x00f8, '', 'Mouse', 'Btn 5'),
    'MW_UP': (0x00f9, '', 'MWheel', 'Up'),
    'MW_DOWN': (0x00fa, '', 'MWheel', 'Down'),
    'MW_LEFT': (0x00fb, '', 'MWheel', 'Left'),
    'MW_RIGHT': (0x00fc, '', 'MWheel', 'Right'),
    'MS_ACC0': (0x00fd, '', 'Mouse', 'Accel0'),
    'MS_ACC1': (0x00fe, '', 'Mouse', 'Accel1'),
    'MS_ACC2': (0x00ff, '', 'Mouse', 'Accel2'),
    'RESET': (0x5c00, '', 'Reset', ''),
    'DEBUG': (0x5c01, '', 'Debug', ''),
    'MAGIC_TOGGLE_NKRO': (0x5c14, '', 'Toggle', 'NKRO'),
    'KC_GESC': (0x5c16, '~', '', 'Esc'),
    'BL_ON': (0x5cbb, '', 'Bklight', 'On'),
    'BL_OFF': (0x5cbc, '', 'Bklight', 'Off'),
    'BL_DEC': (0x5cbd, '', 'Bklight', 'Dec'),
    'BL_INC': (0x5cbe, '', 'Bklight', 'Inc'),
    'BL_TOGG': (0x5cbf, '', 'Bklight', 'Toggle'),
    'BL_STEP': (0x5cc0, '', 'Bklight', 'Step'),
    'BL_BRTG': (0x5cc1, '', 'Bklight', 'Bright'),
    ...
    'RGB_M_P': (0x5ccd, '', 'RGB viz', 'Plain'),
    'RGB_M_B': (0x5cce, '', 'RGB viz', 'Breathe'),
    'RGB_M_R': (0x5ccf, '', 'RGB viz', 'Rainbow'),
    'RGB_M_SW': (0x5cd0, '', 'RGB viz', 'Swirl'),
    'RGB_M_SN': (0x5cd1, '', 'RGB viz', 'Snake'),
    'RGB_M_K': (0x5cd2, '', 'RGB viz', 'KITT'),
    'RGB_M_X': (0x5cd3, '', 'RGB viz', 'Xmas'),
    'RGB_M_G': (0x5cd4, '', 'RGB viz', 'Grad'),
...
dups = {
    ...
    'KC_MS_WH_UP': 'MW_UP',
    'KC_MS_WH_DOWN': 'MW_DOWN',
    'KC_MS_WH_RIGHT': 'MW_RIGHT',
    'KC_MS_WH_LEFT': 'MW_LEFT',
